  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="操作" width="290" align="center">
        <template slot-scope="scope">
          <el-button type="primary" class="el-icon-remove" size="mini" title="修改密码" @click="pawRow(scope.row)"></el-button>
          <el-button type="danger" class="el-icon-delete" size="mini" title="删除" @click="del(scope.row)"></el-button>
        </template>
      </el-table-column>
    </el-table>
      <el-pagination
